<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaterialInward.aspx.cs" Inherits="WindingsIndia.MaterialInward" %>
            ...
            <div id="container">
              ...
              <div class="intro">
                ...
                <div id="application">
                    ...
                    <nav id="secondary">
                        <ul>
                            <li class="current"><a href="#RawMaterial">Raw Material Inward</a></li>
                            <li><a href="AssemblyInward.aspx">Assembly Inward</a></li>
                        </ul>
                    </nav>
                    <!-- The content -->
                    <section id="content">
